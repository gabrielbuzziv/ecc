    ...
    export default {
        ...
        methods: {
            calcular () {
                ...
                localStorage.setItem('sac.postecipada.saldo', this.form.saldo)
                localStorage.setItem('sac.postecipada.parcelas', this.form.parcelas)
                localStorage.setItem('sac.postecipada.taxa', this.form.taxa)
                localStorage.setItem('sac.postecipada.tipo_taxa', this.form.tipo_taxa)
                localStorage.setItem('sac.postecipada.pmt', this.form.pmt)
        ...
        beforeMount () {
            this.form = {
                saldo: localStorage.getItem('sac.postecipada.saldo') || '',
                parcelas: localStorage.getItem('sac.postecipada.parcelas') || '',
                taxa: localStorage.getItem('sac.postecipada.taxa') || '',
                tipo_taxa: localStorage.getItem('sac.postecipada.tipo_taxa') || "Anual",
                pmt: localStorage.getItem('sac.postecipada.pmt') || ''
            }
