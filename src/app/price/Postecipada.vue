    ...
    export default {
        ...
        methods: {
            calcular () {
                ...
                localStorage.setItem('price.postecipada.saldo', this.form.saldo)
                localStorage.setItem('price.postecipada.parcelas', this.form.parcelas)
                localStorage.setItem('price.postecipada.taxa', this.form.taxa)
                localStorage.setItem('price.postecipada.tipo_taxa', this.form.tipo_taxa)
        ...
        beforeMount () {
            this.form = {
                saldo: localStorage.getItem('price.postecipada.saldo') || '',
                parcelas: localStorage.getItem('price.postecipada.parcelas') || '',
                taxa: localStorage.getItem('price.postecipada.taxa') || '',
                tipo_taxa: localStorage.getItem('price.postecipada.tipo_taxa') || "Anual",
            }
